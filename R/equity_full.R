#' Display all equity statement content from a company's filing.
#'
...
#'
#' @return All equity statement content from this company's filing.
#'
#' @export

equity_full <- function(ticker, form_type, filing_order, subscription_key) {
