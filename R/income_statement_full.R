#' Display all income statement content from a company's filing.
#'
...
#'
#' @return All income statement content from this company's filing.
#'
#' @export

income_statement_full <- function(ticker, form_type, filing_order, subscription_key) {
