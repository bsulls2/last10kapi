#' Display all liabilities content from a company's filing.
#'
...
#'
#' @return All content related to liabilities from recent events or transactions from this company's filing.
#'
#' @export

liabilities_full <- function(ticker, form_type, filing_order, subscription_key) {
