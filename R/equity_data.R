#' Create a data frame of a company's equity statement.
#'
...
#'
#' @return A data frame of the chosen company's equity statement line items.
#'
#' @export

equity_data <- function(ticker, form_type, filing_order, subscription_key) {
  url <- paste("https://services.last10k.com/v1/company", ticker, "equity?formType=", sep = "/")
  ...
  equity <- map_df(data_url$Data, extract) %>%
