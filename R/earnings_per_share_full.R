#' Display all earnings per share content from a company's filing.
#'
...
#'
#' @return All earnings per share content from this company's filing.
#'
#' @export

earnings_per_share_full <- function(ticker, form_type, filing_order, subscription_key) {
