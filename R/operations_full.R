#' Display all statement of operations content from a company's filing.
#'
...
#'
#' @return All statement of operations content from this company's filing.
#'
#' @export

operations_full <- function(ticker, form_type, filing_order, subscription_key) {
